<x-layouts.admin title="Dashboard Petugas Gudang">
    <div class="space-y-7">
        ...
        <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-600 p-8 md:p-10 text-white shadow-xl shadow-emerald-500/25">
            ...
            <div class="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-5">
                ...
                <a href="{{ route('petugas.verifikasi.index') }}" class="flex-shrink-0 inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl bg-white text-emerald-700 font-extrabold text-xs uppercase tracking-wider shadow-lg hover:bg-emerald-50 hover:scale-105 transition-all">
        ...
        <div class="bg-white rounded-3xl border border-slate-200/70 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-slate-100 flex items-center justify-between">
                ...
                <a href="{{ route('petugas.verifikasi.index') }}" class="text-xs font-bold text-emerald-600 hover:text-emerald-800 bg-emerald-50 hover:bg-emerald-100 px-3 py-1.5 rounded-xl transition-all">Semua Verifikasi</a>
            </div>
                    ...
                    @foreach($pendingReturns as $item)
                        <div class="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-emerald-50/30 transition-colors">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <a href="{{ route('petugas.verifikasi.show', $item) }}" class="px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold text-xs rounded-xl shadow-md shadow-emerald-500/30 transition-all hover:scale-[1.02]">
                                    Verifikasi
                                </a>
                            </div>
                        </div>
