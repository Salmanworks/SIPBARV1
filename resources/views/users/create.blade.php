    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 md:p-8 rounded-3xl border border-slate-200/80 shadow-soft">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight font-display">Tambah Pengguna</h1>
                    <p class="text-xs text-slate-500 mt-0.5">Daftarkan akun pengguna baru ke dalam sistem SIPBAR</p>
                </div>
            </div>
        </div>
        ...
        {{-- Form Container --}}
        <form method="POST" action="{{ route('admin.user.store') }}" class="bg-white rounded-3xl border border-slate-200/80 shadow-soft p-6 md:p-8 space-y-6">
            @csrf
            ...
            <div class="space-y-5">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="email@sekolah.sch.id" required
                    ...
                    <div>
                        ...
                        <input type="text" id="identitas" name="identitas" value="{{ old('identitas') }}" placeholder="Contoh: 198501..."
