    ...
    <section id="home" class="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50">
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                ...
                <div class="relative animate-scale-in lg:pl-8 mt-8 lg:mt-0" style="animation-delay: 0.2s;">
                    {{-- Floating Cards --}}
                    <div class="relative max-w-lg mx-auto lg:max-w-none">
                        ...
                        <div class="hidden lg:block absolute -top-6 -right-6 bg-white rounded-xl shadow-lg border border-slate-200 p-4 max-w-[200px] animate-float z-20">
                            <div class="flex items-start gap-3">
                        ...
                        {{-- Floating User Card --}}
                        <div class="hidden lg:block absolute -bottom-6 -left-6 bg-white rounded-xl shadow-lg border border-slate-200 p-4 max-w-[200px] z-20" style="animation: float 6s ease-in-out infinite;">
