<x-layouts::auth :title="__('Lupa Kata Sandi')">
    ...
    <div class="text-center mb-8">
        <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 shadow-lg shadow-amber-500/30 mb-4">
        ...
        <p class="text-xs text-slate-500 font-medium mt-2 max-w-xs mx-auto leading-relaxed">
            Masukkan email terdaftar Anda dan kami akan mengirimkan tautan untuk mereset kata sandi.
        </p>
    </div>
    ...
    <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input
                    ...
                    class="w-full pl-10 pr-4 py-3 bg-slate-50/80 border border-slate-200 rounded-2xl text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:bg-white transition-all duration-200 @error('email') border-rose-500 focus:ring-rose-500 @enderror"
                />
            </div>
            @error('email')
        ...
        <button
            ...
            class="w-full py-3.5 px-6 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 hover:from-amber-600 hover:to-orange-600 text-white font-bold text-sm rounded-2xl shadow-lg shadow-amber-500/30 hover:shadow-xl hover:shadow-amber-500/40 transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] focus:outline-none focus:ring-2 focus:ring-amber-500"
        >
            Kirim Tautan Reset
        </button>
    </form>
