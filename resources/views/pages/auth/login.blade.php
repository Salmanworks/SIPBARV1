<x-layouts::auth :title="__('Masuk ke Akun')">
    ...
    <script>
        ...
        const roleIcons = {
            ...
            petugas: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        function handleRoleChange(role) {
            ...
            if (role === 'siswa') {
                ...
                roleBadge.innerHTML = roleIcons.petugas + '<span id="role-badge-text">Mode Admin / Petugas</span>';
                roleIconContainer.innerHTML = roleIcons.petugas;
